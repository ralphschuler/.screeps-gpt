...
describe("Deploy Workflow Version Resolution - Modernized CI/CD", () => {
  it("should use simplified version resolution logic", () => {
    // The modernized deploy workflow uses simpler version resolution:
    // - Tag push events: extract from github.ref_name
    ...
    expect(workflowContent).toContain("github.event.release.tag_name");
