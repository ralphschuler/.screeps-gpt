...
module.exports = function (config) {
          ...
          actions: [
            {
              ...
              params: [
                {
                  action: "MoveTo",
                  params: [{ $state: "x", koef: 100 }, { $state: "y", koef: 100 }, { $processorParam: "tickDuration" }]
                },
                "EASE_IN_OUT_QUAD"
              ]
            }
  ...
  if (config.engine) {
    ...
    config.engine.on(
      ...
      function (object, userId, intents, roomObjects, roomTerrain, gameTime, roomInfo, objectsUpdate, usersUpdate) {
