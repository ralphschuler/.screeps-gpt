...
import type { SwarmState, CreepRole, RoleFamily, SwarmCreepMemory } from "../memory/schemas";
import { weightedSelection, type WeightedEntry } from "../utils/weightedSelection";
 ...
 */
function createBody(parts: BodyPartConstant[], minCapacity: number = 0): BodyTemplate {
  return {
    parts,
