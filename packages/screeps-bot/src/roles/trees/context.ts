/**
 * Extended Context for Swarm Bot Decision Trees
 *
 * Extends the base CreepDecisionContext with additional context
 * specific to the swarm bot's pheromone-based decision making.
 */

import type { SwarmCreepMemory, SwarmState, SquadMemory } from "../../memory/schemas";
...
/**
 * Action types that can be returned by decision trees
 */
